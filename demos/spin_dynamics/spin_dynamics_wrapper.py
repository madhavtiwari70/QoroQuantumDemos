...
Reuses the ACTUAL functions from vendor/divi-demos/spin_dynamics/
spin_dynamics.py and plotting.py — unmodified, synced verbatim from
QoroQuantum/divi-demos by sync_demos.sh. Only the __main__ block's
hardcoded constants are replaced with values read from a data file.
"""
...
VENDOR_DIR = os.path.join(
    os.path.dirname(__file__), "..", "..", "vendor", "divi-demos", "spin_dynamics"
)
sys.path.insert(0, os.path.abspath(VENDOR_DIR))

from spin_dynamics import build_tfim_hamiltonian, run_trajectory
